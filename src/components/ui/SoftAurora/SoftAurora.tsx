...
/**
 * WebGL 极光动效（来自 React Bits SoftAurora）
 * - 仅在容器进入视口时启动 RAF，离开时停掉，零 GPU 消耗
 * - 鼠标交互用 lerp 平滑跟随，禁用时鼠标坐标恒为 (0.5, 0.5)
 * - 组件卸载时正确释放 WebGL context + 移除 canvas + 移除所有事件
 * - `prefers-reduced-motion`：保留渲染但亮度降到 0（容器仍是空的，节能）
 */
